...
mpc.bus = [
	...
	59	 2	 360.1	 146.9	 0.0	 0.0	 1	    1.00000	    0.00000	 138.0	 1	    1.06000	    0.94000;
    ...
    116	 2	 239.2	 0.0	 0.0	 0.0	 1	    1.00000	    0.00000	 138.0	 1	    1.06000	    0.94000;
...
%mpc.bus(:,3) = mpc.bus(:,3)*1.2;%0.8 1 1.2 1.4
% mpc.bus(:,4) = mpc.bus(:,4)*1.1;
% mpc.bus(:,12) = 1.03;%
% mpc.bus(:,13) = 0.97;%
%% generator data
